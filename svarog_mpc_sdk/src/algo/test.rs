...
/*
    This is a modified version of Kzen Networks' Multi-party ECDSA library
    (https://github.com/KZen-networks/multi-party-ecdsa/src/protocols/multi_party_ecdsa/gg_2018/test.rs) 
*/
